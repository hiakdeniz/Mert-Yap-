...
class SipverState extends State<Sipver> with SingleTickerProviderStateMixin {
  ...
  final TextEditingController _controllerproductno = TextEditingController();
  final TextEditingController _controlleruser = TextEditingController();
  final TextEditingController _controllerPName = TextEditingController();
  final TextEditingController _controllerBarcode = TextEditingController();
  final TextEditingController _controllerTutar = TextEditingController();
  final TextEditingController _controllerSatisFiyat = TextEditingController();
  ...
  final TextEditingController _controllerGelis = TextEditingController();
  ...
  void loadInfo() async {
    ...
    try {
      if (!info) {
        _controllerproductno.text = widget.PCode.toString();
        _controlleruser.text = widget.TFPath.toString();
        _controllerPName.text = widget.PName.toString();
        _controllerBarcode.text = widget.Barcode.toString();
        _controllerTutar.text = widget.Bakiye.toString();
        _controllerSatisFiyat.text = widget.outPrice.toString();
        _controllerStok.text = widget.Stok.toString();
        _controllerAciklama.text = widget.Notes.toString();
        _controllerGelis.text = widget.inPrice.toString();
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      ...
                                      double? a = double.tryParse(
                                              _controllerSatisFiyat.text) ??
                                          0;
                                      double? b = double.tryParse(
                                              _controllerStok.text) ??
                                          0;
                                      _controllerTutar.text = (a * b)
                                          .toString()
                                          .replaceAll(
                                              RegExp(r'\B(?=(\d{3})+(?!\d))'),
                                              ',');
                                  ...
                                  obscureText: false,
                                  keyboardType: TextInputType.number,
                                  controller: _controllerSatisFiyat,
                                  autocorrect: false,
                                ),
                              )
                            ],
